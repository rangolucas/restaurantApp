class MenuController
  ...
  def initialize(get_menu_action, add_item_action, remove_item_action, codec)
  ...
  def remove_item(store_id, menu_item_id)
    @remove_item_action.invoke(store_id, menu_item_id)
  end
end
